...
public class EventLoader {
    public static void load(NukkitMain instance) {
        ...
        pm.registerEvents(new TapCanon(), instance);
        ...
        pm.registerEvents(new ClickGererIle(), instance);
            ...
            //CanonUI
        pm.registerEvents(new SummonCanon(), instance);
        pm.registerEvents(new ClickCanonStart(), instance);
        pm.registerEvents(new ClickCanonStop(), instance);
        pm.registerEvents(new ClickCanonVise(), instance);
        pm.registerEvents(new SendCanonVise(), instance);
    }
}
